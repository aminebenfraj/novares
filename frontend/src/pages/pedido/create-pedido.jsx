...
import { CalendarIcon, Save, ArrowLeft, Loader2, ClipboardList } from "lucide-react"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: "Failed to create pedido. Please try again.",
      })
    } finally {
      setIsSaving(false)
    }
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="fabricante" name="fabricante" value={pedido.fabricante} onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="ano">Year</Label>
                    <Input id="ano" name="ano" type="number" value={pedido.ano} onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="recepcionado">Received Status</Label>
                    <Select
