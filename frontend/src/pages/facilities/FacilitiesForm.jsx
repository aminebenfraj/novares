...
const initialFormData = facilityFields.reduce((acc, field) => {
  acc[field] = {
    value: false,
    task: {
      check: false,
...
const FacilitiesForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("📢 Sending Facilities Data:", JSON.stringify(submissionData, null, 2));

    try {
      await createfacilities(submissionData);
      navigate("/");
    } catch (error) {
    ...
    <div>
      ...
      <div className="container p-6 mx-auto bg-gray-50">
        <Card className="max-w-4xl mx-auto bg-white shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-gray-900">Create Facility</CardTitle>
          </CardHeader>
          <CardContent>
