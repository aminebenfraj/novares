...
import { Sparkles, ArrowLeft, Building, User, Phone, Mail, Loader2, AlertCircle } from "lucide-react"
        ...
        <div className="container p-4 py-8 mx-auto">
          ...
          >
            ...
            <div className="flex flex-col space-y-2 md:flex-row md:items-center md:justify-between md:space-y-0">
              <div>
                <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100">Create New Supplier</h1>
                <p className="text-zinc-500 dark:text-zinc-400">Add a new supplier to your inventory system</p>
              </div>
            </div>
          </motion.div>
