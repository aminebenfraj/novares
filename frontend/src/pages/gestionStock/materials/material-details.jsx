                        ...
                        {material.materialHistory.map((history, index) => (
                          ...
                          >
                            <div className="flex items-start justify-between">
                              ...
                              <Badge variant="outline">{history.changedBy ? history.changedBy.name : "Unknown"}</Badge>
                            </div>
                          ...
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                ...
                                <p className="text-sm font-medium">{new Date(history.changedDate).toLocaleString()}</p>
                              </div>
                              <Badge variant="outline">{history.changedBy ? history.changedBy.name : "Unknown"}</Badge>
                            </div>
                            <div className="mt-2">
