...
import { Upload, CalendarIcon, ArrowLeft, Save, Loader2, CheckCircle, XCircle, Users, UserCheck } from "lucide-react"
...
const EditQualificationConfirmation = () => {
  ...
  const [activeTab, setActiveTab] = useState(qualificationConfirmationFields[0])
  ...
  const fetchQualificationConfirmation = async () => {
    ...
    try {
      ...
      if (!data) {
        throw new Error("Qualification Confirmation data not found.")
      }
      ...
      console.error("Error fetching Qualification Confirmation data:", error)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to update qualification confirmation. Please try again.",
        variant: "destructive",
      })
    } finally {
      setSubmitting(false)
      ...
      <div className="container px-4 py-8 mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Failed to load qualification confirmation data</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-red-500">{error}</p>
          </CardContent>
          <CardFooter>
            <Button onClick={() => navigate("/qualification-confirmation")}>
              <ArrowLeft className="w-4 h-4 mr-2" /> Back to Qualification Confirmation
            </Button>
          </CardFooter>
        </Card>
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Update confirmation details and tasks</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
              <Card className="md:col-span-1">
                <CardHeader>
                  <CardTitle>Confirmation Fields</CardTitle>
              ...
              <Card className="md:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>
                    {fieldConfig[activeTab]?.description || "Update confirmation details"}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <TabsContent value="details" className="pt-4 space-y-6">
                      ...
                      >
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          ...
                          {/* Remove this block from the task details tab content: */}
                        </div>
