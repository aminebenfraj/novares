...
const EditQualificationConfirmation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Failed to update Qualification Confirmation. Please try again.")
    }
  }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <Card className="max-w-4xl mx-auto bg-white shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-gray-900">Edit Qualification Confirmation</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full text-white bg-green-600 hover:bg-green-700">
                Update Qualification Confirmation
              </Button>
            </form>
          </CardContent>
        </Card>
