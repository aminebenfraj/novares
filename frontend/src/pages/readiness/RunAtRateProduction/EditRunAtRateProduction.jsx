            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Update run-at-rate production details and validation information
                </p>
              </div>
            </div>
                  ...
                  <Tabs defaultValue="status" className="w-full">
                    ...
                    <TabsContent value="validation" className="pt-4 space-y-6">
                      ...
                      >
                        ...
                        {activeTab === "selfRunRatePerformed" && (
                          <div className="mt-6 space-y-2">
                            <Label>Validation Details</Label>
                            <div className="overflow-hidden border rounded-md">
                              <table className="w-full">
                        ...
                        {activeTab === "dimensionalInspectionsConform" && (
                          <div className="mt-6 space-y-2">
                            <Label>Validation Details</Label>
                            <div className="overflow-hidden border rounded-md">
                              <table className="w-full">
