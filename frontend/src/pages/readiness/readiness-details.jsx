  ...
  const stages = [
    {
      ...
      path: `readiness/${id}/documentation`,
    },
    {
      id: "logistics",
      name: "Logistics",
    ...
    },
    {
      ...
      path: `readiness/${id}/process-status-industrials`,
    },
    {
      id: "productProcess",
      ...
      path: `readiness/${id}/product-process`,
    },
    {
    ...
    },
    {
      ...
      path: `readiness/${id}/tooling-status`,
    },
    {
      id: "training",
      name: "Training",
