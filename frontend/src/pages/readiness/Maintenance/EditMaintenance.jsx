...
import { getMaintenanceById, updateMaintenance } from "../../../apis/readiness/maintenanceApi"

// Define the field labels and descriptions for better UI
const fieldConfig = {
  sparePartsIdentifiedAndAvailable: {
    label: "Spare Parts Available",
    description: "Spare parts identified and available",
  },
  processIntegratedInPlantMaintenance: {
    label: "Process Integrated",
    description: "Process integrated in plant maintenance",
  },
  maintenanceStaffTrained: {
    label: "Staff Trained",
    description: "Maintenance staff trained",
  },
}
...
function EditMaintenancePage() {
  ...
  useEffect(() => {
    const fetchMaintenance = async () => {
      try {
        setIsLoading(true)
        const data = await getMaintenanceById(params.id)
        setMaintenance(data)
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateMaintenance(params.id, maintenance)
      ...
      // Navigate back to maintenance details page
      ...
      <div className="container px-4 py-8 mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Maintenance not found</CardDescription>
          </CardHeader>
          <CardFooter>
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <Button variant="outline" size="icon" onClick={() => navigate(`/maintenance/${params.id}`)}>
              <ArrowLeft className="w-4 h-4" />
            </Button>
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Edit Maintenance</h1>
              <p className="text-muted-foreground">Update maintenance details and validation information</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            <Card className="md:col-span-1">
              <CardHeader>
                <CardTitle>Maintenance Fields</CardTitle>
            ...
            <Card className="md:col-span-3">
                ...
                <Tabs defaultValue="status" className="w-full">
                  ...
                  <TabsContent value="status" className="pt-4">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id={`${activeTab}-value`}
                        checked={maintenance[activeTab]?.value || false}
                    ...
                    >
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-tko`}
                              checked={maintenance[activeTab]?.details?.tko || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-ot`}
                              checked={maintenance[activeTab]?.details?.ot || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-ot_op`}
                              checked={maintenance[activeTab]?.details?.ot_op || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-is`}
                              checked={maintenance[activeTab]?.details?.is || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-sop`}
                              checked={maintenance[activeTab]?.details?.sop || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              ...
                              checked={maintenance[activeTab]?.details?.validation_check || false}
                              onCheckedChange={(checked) =>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <RadioGroup
                            value={maintenance[activeTab]?.details?.ok_nok || ""}
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          <div className="space-y-2">
                            ...
                            <Input
                              id={`${activeTab}-who`}
                              value={maintenance[activeTab]?.details?.who || ""}
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            value={maintenance[activeTab]?.details?.comment || ""}
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" onClick={() => navigate(`/maintenance/${params.id}`)}>
                  Cancel
                </Button>
