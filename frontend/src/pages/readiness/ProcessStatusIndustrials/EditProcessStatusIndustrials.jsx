          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            ...
            <Card className="md:col-span-3">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-tko`}
                              checked={processStatus[activeTab]?.details?.tko || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-ot`}
                              checked={processStatus[activeTab]?.details?.ot || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-ot_op`}
                              checked={processStatus[activeTab]?.details?.ot_op || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-is`}
                              checked={processStatus[activeTab]?.details?.is || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id={`${activeTab}-sop`}
                              checked={processStatus[activeTab]?.details?.sop || false}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              ...
                              checked={processStatus[activeTab]?.details?.validation_check || false}
                              onCheckedChange={(checked) =>
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" onClick={() => navigate(`/process-status-industrials/${params.id}`)}>
                  Cancel
                </Button>
