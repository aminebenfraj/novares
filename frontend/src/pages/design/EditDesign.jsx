...
const EditDesign = () => {
  ...
  const [activeTab, setActiveTab] = useState(designFields[0])
      ...
      <div className="container px-4 py-8 mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Failed to load design data</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Update design details and tasks</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
              <Card className="md:col-span-1">
                <CardHeader>
                  <CardTitle>Design Fields</CardTitle>
              ...
              <Card className="md:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>{fieldConfig[activeTab]?.description || "Update design details"}</CardDescription>
                </CardHeader>
                <CardContent>
