...
var _require = require("../controllers/p_p_tuningController"),
  createP_P_Tuning = _require.createP_P_Tuning,
  getAllP_P_Tuning = _require.getAllP_P_Tuning,
  getP_P_TuningById = _require.getP_P_TuningById,
  updateP_P_Tuning = _require.updateP_P_Tuning,
  deleteP_P_Tuning = _require.deleteP_P_Tuning;
