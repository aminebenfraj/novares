...
var PedidoSchema = new mongoose.Schema({
  ...
  // Auto-filled from Material supplier
  comentario: String,
  pedir: {
    type: String,
    index: true
  ...
  aceptado: Date,
  date_receiving: Date,
  // New field for receiving date (2 weeks after acceptance)
  direccion: String,
  weeks: {
    type: Number
  },
  ...
  // Will contain a QR code representing the Pedido ID
  ano: {
    type: Number,
    index: true
  }
...
PedidoSchema.pre("save", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(next) {
    var Material, material, acceptanceDate, receivingDate;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return Material.findById(this.referencia).populate("supplier");
        case 4:
        ...
        case 6:
          ...
          if (this.aceptado && !this.date_receiving) {
            acceptanceDate = new Date(this.aceptado);
            receivingDate = new Date(acceptanceDate);
