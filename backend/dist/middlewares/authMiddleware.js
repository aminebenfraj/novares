    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          // Verify token
          decoded = jwt.verify(token, process.env.JWT_SECRET); // Get user from database using `license` (typo fixed from `lisence`)
          _context.next = 6;
          return User.findOne({
        ...
        case 12:
          ...
          console.error("Not authorized, token failed", _context.t0);
          res.status(401).json({
